...
public class MoveAndSlide extends Command {
    ...
    public MoveAndSlide(Hardware robot, double totalDistance, double riseDistance, double fallDistance, ElapsedTime timer, double timeOut, double powerLevel, int position, double sPowerLevel) {
        super(robot);
        this.timer = timer;
    ...
    public MoveAndSlide(Hardware robot, double totalDistance, double riseDistance, double fallDistance, ElapsedTime timer, double timeOut, double powerLevel, int position, double sPowerLevel, boolean correction, double heading, double gain) {
        super(robot);
        this.timer = timer;
        this.inches=totalDistance;
        if (timeOut < 0) {
