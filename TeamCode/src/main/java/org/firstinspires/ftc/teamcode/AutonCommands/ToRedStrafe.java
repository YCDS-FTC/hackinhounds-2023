...
public class ToRedStrafe extends Command {
    ...
    public ToRedStrafe(Hardware robot, ElapsedTime timer, double timeOut, double powerLevel) {
        super(robot);
        this.timer = timer;
